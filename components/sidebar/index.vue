<template>
  <div class="px-3 py-5 lg:sticky lg:top-0 lg:h-screen flex lg:flex-col fixed bottom-0 left-0 max-lg:w-full items-center justify-center gap-5 bg-zinc-800 bg">
