<template>
  <div class="px-3 py-5 z-10 lg:sticky lg:top-0 lg:h-screen flex lg:flex-col fixed bottom-0 left-0 max-lg:w-full items-center justify-center gap-5 bg-zinc-800 bg">
    <div class="p-1 w-12 bg-gray-200 rounded-2xl">
